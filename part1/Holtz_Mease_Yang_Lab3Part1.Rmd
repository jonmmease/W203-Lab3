...
#### CLM Assumptions
 ...
 1. Population model is linear
 2. We have a random sample
 3. None of the variables are constant or have perfect collinearity
 4. E(u|x1, x2, ..., xk) = 0
 5. var(u|x1, x2, ..., xk) is independent of x's (homoskedasticity)
 6. u is independent of x's and normally distributed with zero mean

The model has 90 random observations, the parameters are unknown, there is no colilinearity between each of the parameters.  The residual vs. fitted value plot shows the residuals apprear to be centered at 0, also we don't see any patterns in the residuals.  We transformed crmrte, prbarr and polpc to meet the homoskedasticity assumption
