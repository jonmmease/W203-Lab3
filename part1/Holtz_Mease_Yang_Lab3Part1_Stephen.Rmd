...
>>>>>>> 6c0c2497e610a7dde50b8e428660ce2647f460e7
```
...
The results from the polpc (Police percapita) variable is counterintuitive at first glance. However, on further 
examination, it becomes clear that both crime rate and police percapita increase with increasing density, however,
crime rate increases faster with density than police percapita. The net result is that there is a positive 
